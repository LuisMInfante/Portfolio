const projects = [
	{
		...
		technologies: [
			{ name: 'vue', iconUrl: null, alt: 'Vue.js', url: 'https://vuejs.org/' },
			{ name: 'fastapi', iconUrl: null, alt: 'FastAPI', url: 'https://fastapi.tiangolo.com/' },
			{ name: 'opencv', iconUrl: null, alt: 'OpenCV', url: 'https://opencv.org/' },
			{ name: 'py', iconUrl: null, alt: 'Python', url: 'https://www.python.org/' }
		],
		description: [
			'Developed an interactive tool designed to master blackjack strategies through real-time simulation and feedback',
			'Improved playing card detection accuracy by 80% using advanced OpenCV techniques, ensuring reliable recognition',
			'Increased frame processing speed by 40% through algorithm optimization'
		],
		url: 'https://github.com/jonleed/DeckDetective'
	},
	{
		...
		technologies: [
			{ name: 'cpp', iconUrl: null, alt: 'C++', url: 'https://isocpp.org/' },
			{
				name: 'glfw',
				iconUrl:
					'https://camo.githubusercontent.com/a9db60d147588c76634f8e08d11370be8064417d2abaf3c677467d340fbea237/68747470733a2f2f7777772e736161736875622e636f6d2f696d616765732f6170702f736572766963655f6c6f676f732f33382f6234386363383563656262322f6c617267652e706e673f31353533323434303234',
				alt: 'GLFW',
				url: 'https://www.glfw.org/'
			},
			{
				name: 'imgui',
				iconUrl: 'https://raw.githubusercontent.com/wiki/sammyfreg/netImgui/Web/img/DearImGui.png',
				alt: 'ImGui',
				url: 'https://github.com/ocornut/imgui'
			},
			{
				name: 'premake',
				iconUrl: 'https://premake.github.io/img/premake-logo.png',
				alt: 'Premake',
